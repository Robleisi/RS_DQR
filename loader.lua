...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1747161,
		expectedFnv = "667047B4",
		expectedDjb = "369BB30C",
		expectedHead = "return(function(...)local AU={\"\\053\\053\\051\\109\",\"\\100\\073\\104\\121\",\"\\",
		expectedTail = "G or FU[vU(kU(-643892+614780),-393068+6154876360144)]))end)(...)",
	},
}
