...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1742679,
		expectedFnv = "600651B2",
		expectedDjb = "37BB3ED4",
		expectedHead = "return(function(...)local N3={\"\\066\\089\\105\\108\\053\\066\\119\\103\\043\\11",
		expectedTail = " or C3[k3(n3(-40511-(-73506)),14633400672236-518832)]))end)(...)",
	},
}
