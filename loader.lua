...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1770588,
		expectedFnv = "B89DAAF9",
		expectedDjb = "9B59A7ED",
		expectedHead = "return(function(...)local k6={\"\\104\\079\\108\\074\",\"\\070\\109\\121\\105\\109",
		expectedTail = " R6[o6(A6(-83603-(-131236)),8571941869433-(-706486))]))end)(...)",
	},
}
