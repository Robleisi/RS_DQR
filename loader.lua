...
local profiles = {
	reborn = {
		...
		expectedLen = 1671815,
		expectedFnv = "B606A0F3",
		expectedDjb = "06276A1B",
		expectedHead = "return(function(...)local p_={\"\\111\\117\\114\\055\\107\\070\\061\\061\",\"\\115",
		expectedTail = "r y_[J_(H_(728823+-743990),20917128252575-(-819065))]))end)(...)",
	},
	classic = {
		kind = "classic",
		stamp = "2026-09-18v",
		...
		expectedLen = 1741308,
		expectedFnv = "734F2DE8",
		expectedDjb = "FD2CCD74",
		expectedHead = "return(function(...)local v8={\"\\055\\051\\083\\078\\102\\080\\122\\048\\054\\10",
		expectedTail = "OG or C8[y8(V8(857474-839354),20935383481232-241511)]))end)(...)",
	},
}
