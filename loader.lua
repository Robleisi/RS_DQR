...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1732687,
		expectedFnv = "01C35E5A",
		expectedDjb = "1C3BE648",
		expectedHead = "return(function(...)local yk={\"\\080\\075\\090\\115\";\"\\100\\050\\116\\081\\115",
		expectedTail = "G or Gk[Ek(fk(795905-802873),-919933+33777728291934)]))end)(...)",
	},
}
