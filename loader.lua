...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1683273,
		expectedFnv = "BF526A62",
		expectedDjb = "62867326",
		expectedHead = "return(function(...)local gr={\"\\087\\057\\081\\100\\055\\116\\051\\102\\113\\11",
		expectedTail = "OG or ir[Kr(Hr(-164261+148401),1189743154768-905724)]))end)(...)",
	},
}
