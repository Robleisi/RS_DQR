...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1721550,
		expectedFnv = "9DC6A314",
		expectedDjb = "3D095AE0",
		expectedHead = "return(function(...)local xk={\"\\120\\098\\043\\117\\070\\116\\102\\120\\090\\10",
		expectedTail = "G or wk[zk(qk(580989-584306),-220391+21087859452318)]))end)(...)",
	},
}
