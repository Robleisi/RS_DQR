...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1680249,
		expectedFnv = "CCC621FE",
		expectedDjb = "75948E76",
		expectedHead = "return(function(...)local pL={\"\\105\\084\\110\\098\\075\\107\\066\\111\\056\\06",
		expectedTail = "r RL[KL(gL(-711252-(-704950)),-211367+5558931279328)]))end)(...)",
	},
}
