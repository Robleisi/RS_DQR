...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1734902,
		expectedFnv = "21E7937C",
		expectedDjb = "1FCD3682",
		expectedHead = "return(function(...)local Wb={\"\\043\\054\\100\\111\\087\\098\\120\\066\\085\\09",
		expectedTail = " xb[nb(bb(-244211-(-196198)),-601523+26330027396476)]))end)(...)",
	},
}
