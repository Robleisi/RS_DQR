...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1760117,
		expectedFnv = "0077C0CC",
		expectedDjb = "9E8B53D8",
		expectedHead = "return(function(...)local of={\"\\074\\101\\122\\074\";\"\\049\\047\\121\\115\\113",
		expectedTail = "OG or Cf[Wf(Sf(241235-170597),27241662235411-811001)]))end)(...)",
	},
}
