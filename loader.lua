...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1096285,
		expectedFnv = "6D110764",
		expectedDjb = "AD8958C6",
		expectedHead = "local Zj,xj do local y=math.floor local X=math.random local E=table.re",
		expectedTail = "UPDATED),tostring(SCRIPT_CHANGELOG or Zj[xj(\"\",4534550106239)]))",
	},
}
