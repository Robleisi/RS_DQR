...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1677911,
		expectedFnv = "8D67FBA0",
		expectedDjb = "97195EA4",
		expectedHead = "return(function(...)local Sg={\"\\113\\077\\047\\108\";\"\\067\\105\\088\\080\\121",
		expectedTail = "OG or Gg[pg(Ug(507263-559729),532977+26495387549298)]))end)(...)",
	},
}
