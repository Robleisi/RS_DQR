...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1743813,
		expectedFnv = "5C45ACFD",
		expectedDjb = "CC0B7F21",
		expectedHead = "return(function(...)local vh={\"\\057\\072\\103\\116\\082\\106\\053\\069\",\"\\048",
		expectedTail = "or Hh[Th(sh(-30350-(-43937)),-109987+16530759969222)]))end)(...)",
	},
}
