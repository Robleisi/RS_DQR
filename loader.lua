...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1709924,
		expectedFnv = "4D40D04D",
		expectedDjb = "FED4DBD3",
		expectedHead = "return(function(...)local Y4={\"\\097\\097\\110\\076\",\"\\107\\109\\048\\080\\086",
		expectedTail = "or h4[Q4(K4(-521035-(-533041)),1317521987708-562097)]))end)(...)",
	},
}
