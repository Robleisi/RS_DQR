...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1676361,
		expectedFnv = "19761AF3",
		expectedDjb = "76C25F0F",
		expectedHead = "return(function(...)local j7={\"\\071\\051\\085\\112\\083\\088\\114\\066\\121\\04",
		expectedTail = " or e7[l7(g7(-170341+124787),-278185+25533286325132)]))end)(...)",
	},
}
