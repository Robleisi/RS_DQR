...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1726570,
		expectedFnv = "71495FD2",
		expectedDjb = "A17F0626",
		expectedHead = "return(function(...)local OZ={\"\\089\\077\\086\\052\",\"\\108\\079\\114\\065\\100",
		expectedTail = "Z[eZ(zZ(-315702-(-350827)),12810129979934-(-914556))]))end)(...)",
	},
}
