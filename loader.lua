...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1759529,
		expectedFnv = "52DA6B23",
		expectedDjb = "88FEFD87",
		expectedHead = "return(function(...)local e8={\"\\073\\101\\057\\050\\086\\078\\053\\078\\072\\10",
		expectedTail = "OG or N8[P8(i8(-935101+923960),387692+1413086976696)]))end)(...)",
	},
}
