...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1731419,
		expectedFnv = "0CCA9051",
		expectedDjb = "E6EA772B",
		expectedHead = "return(function(...)local z0={\"\\082\\051\\061\\061\",\"\\120\\083\\066\\081\\120",
		expectedTail = "ELOG or a0[Z0(d0(-910588+903819),-4640+463870628816)]))end)(...)",
	},
}
