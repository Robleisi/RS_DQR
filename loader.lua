...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1689977,
		expectedFnv = "EF17D38F",
		expectedDjb = "4390A3DD",
		expectedHead = "return(function(...)local ze={\"\\097\\101\\099\\086\\072\\103\\098\\080\\073\\07",
		expectedTail = " de[re(ge(1061363-1039360),26064803690266-(-780216))]))end)(...)",
	},
}
