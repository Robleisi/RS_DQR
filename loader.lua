...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1754855,
		expectedFnv = "78E908A4",
		expectedDjb = "798326A8",
		expectedHead = "return(function(...)local Hs={\"\\055\\104\\048\\110\\071\\081\\119\\122\\104\\07",
		expectedTail = " or ms[Ls(Os(223872-182310),8141358118884-(-845242))]))end)(...)",
	},
}
