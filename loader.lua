...
local profiles = {
	reborn = {
		...
		expectedLen = 1695268,
		expectedFnv = "6E47BEF2",
		expectedDjb = "AEDCCC68",
		expectedHead = "return(function(...)local kB={\"\\066\\101\\090\\088\";\"\\098\\112\\071\\089\\069",
		expectedTail = "OG or YB[TB(oB(279204-311530),33093733812895-856635)]))end)(...)",
	},
	classic = {
		kind = "classic",
		stamp = "2026-09-25b",
		...
		expectedLen = 1107386,
		expectedFnv = "D6C52463",
		expectedDjb = "C60C5131",
		expectedHead = "local bT,sT do local H=math.floor local p=math.random local Q=table.re",
		expectedTail = "PDATED),tostring(SCRIPT_CHANGELOG or bT[sT(\"\",22542823805442)]))",
	},
}
