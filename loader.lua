...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1719085,
		expectedFnv = "48FFD76A",
		expectedDjb = "1C4A918A",
		expectedHead = "return(function(...)local Jn={\"\\074\\122\\068\\077\\118\\076\\086\\075\\073\\09",
		expectedTail = "LOG or Sn[An(Wn(-2784+45050),-348907+17671108825908)]))end)(...)",
	},
}
