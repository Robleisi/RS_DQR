...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1756226,
		expectedFnv = "3169EAF0",
		expectedDjb = "C5B995FC",
		expectedHead = "return(function(...)local z3={\"\\052\\106\\053\\090\\110\\070\\073\\061\";\"\\102",
		expectedTail = " or a3[l3(T3(-235687+207418),-950589+21111483223562)]))end)(...)",
	},
}
