...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1742091,
		expectedFnv = "F3AB4E46",
		expectedDjb = "B89ED37A",
		expectedHead = "return(function(...)local ij={\"\\079\\105\\078\\097\";\"\\070\\070\\079\\105\\114",
		expectedTail = "or Uj[Xj(Bj(-1013887+1010707),803641+27769957720525)]))end)(...)",
	},
}
