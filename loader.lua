...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1727672,
		expectedFnv = "65680CCC",
		expectedDjb = "CC0832BA",
		expectedHead = "return(function(...)local Te={\"\\097\\119\\078\\119\\088\\121\\061\\061\";\"\\097",
		expectedTail = "G or Me[je(le(-716470+682191),10415613698633-146533)]))end)(...)",
	},
}
