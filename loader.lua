...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1698320,
		expectedFnv = "B5F08219",
		expectedDjb = "3DC0B97D",
		expectedHead = "return(function(...)local cX={\"\\072\\071\\087\\072\\048\\047\\078\\069\\050\\10",
		expectedTail = "r gX[pX(nX(-580902-(-624755)),19195869371283-972222)]))end)(...)",
	},
}
