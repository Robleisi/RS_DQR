...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1102145,
		expectedFnv = "5B447C21",
		expectedDjb = "30D1E77B",
		expectedHead = "local iC,LC do local o=math.floor local T=math.random local w=table.re",
		expectedTail = "UPDATED),tostring(SCRIPT_CHANGELOG or LC[iC(\"\",9718733841243)]))",
	},
}
