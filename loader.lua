...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1738915,
		expectedFnv = "ED8419FD",
		expectedDjb = "FB4A7847",
		expectedHead = "return(function(...)local tk={\"\\101\\104\\081\\122\",\"\\050\\065\\053\\076\\074",
		expectedTail = " or rk[ik(ak(-619635+665736),-629236+28019074858978)]))end)(...)",
	},
}
