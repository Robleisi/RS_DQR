...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1728034,
		expectedFnv = "45E19D99",
		expectedDjb = "8A4203F1",
		expectedHead = "return(function(...)local Zu={\"\\110\\089\\071\\112\\073\\121\\043\\071\\074\\11",
		expectedTail = "r lu[hu(bu(-928036-(-952638)),32887569151520-917116)]))end)(...)",
	},
}
