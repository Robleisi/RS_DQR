...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1753934,
		expectedFnv = "391A8F95",
		expectedDjb = "E4DDEE37",
		expectedHead = "return(function(...)local Xf={\"\\068\\068\\048\\107\\085\\100\\097\\057\\077\\06",
		expectedTail = "G or pf[tf(Bf(633716+-571840),352043+18061962076810)]))end)(...)",
	},
}
