...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1688305,
		expectedFnv = "28A8EB2B",
		expectedDjb = "A1B82DAD",
		expectedHead = "return(function(...)local lk={\"\\050\\084\\098\\104\\055\\118\\069\\043\";\"\\101",
		expectedTail = " Ck[pk(Ok(-427581-(-481391)),537960777740-(-293353))]))end)(...)",
	},
}
