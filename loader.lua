...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1752263,
		expectedFnv = "162970CE",
		expectedDjb = "3ECAC198",
		expectedHead = "return(function(...)local il={\"\\112\\118\\089\\072\\052\\054\\056\\077\",\"\\113",
		expectedTail = "OG or Ul[Ol(Nl(307665-296297),-581426+8752337288969)]))end)(...)",
	},
}
