...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1721138,
		expectedFnv = "5236B664",
		expectedDjb = "A26FD478",
		expectedHead = "return(function(...)local Xx={\"\\051\\119\\098\\099\",\"\\119\\066\\077\\088\",\"\\",
		expectedTail = "r Ux[Yx(kx(-683954-(-718518)),586098+10405948994665)]))end)(...)",
	},
}
