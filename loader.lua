...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1690350,
		expectedFnv = "034E8126",
		expectedDjb = "067BD99C",
		expectedHead = "return(function(...)local iP={\"\\102\\114\\053\\110\\067\\080\\116\\108\\083\\07",
		expectedTail = " or yP[qP(cP(284009+-340092),-406957+17724797613608)]))end)(...)",
	},
}
