...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1127574,
		expectedFnv = "739DD9C4",
		expectedDjb = "7015CF0E",
		expectedHead = "local O9,i9 do local Z=math.floor local o=math.random local m=table.re",
		expectedTail = "PDATED),tostring(SCRIPT_CHANGELOG or i9[O9(\"\",11025517520924)]))",
	},
}
