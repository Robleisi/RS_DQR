...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1710944,
		expectedFnv = "1CC52C82",
		expectedDjb = "734DE30C",
		expectedHead = "return(function(...)local gW={\"\\043\\082\\100\\108\\067\\070\\110\\052\\047\\07",
		expectedTail = "GELOG or jW[yW(iW(357813-376172),581170+35433980399)]))end)(...)",
	},
}
