...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1677990,
		expectedFnv = "5BCAE681",
		expectedDjb = "47EC514B",
		expectedHead = "return(function(...)local f0={\"\\067\\083\\107\\100\",\"\\098\\115\\106\\113\\055",
		expectedTail = "G or t0[n0(w0(-901884+923508),764856+33746587143948)]))end)(...)",
	},
}
