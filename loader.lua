...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1730588,
		expectedFnv = "1CFB9036",
		expectedDjb = "A0F6CFBA",
		expectedHead = "return(function(...)local Jn={\"\\105\\072\\079\\087\\083\\072\\050\\108\\103\\05",
		expectedTail = "OG or on[Fn(tn(403565+-334463),8187531700854-429229)]))end)(...)",
	},
}
