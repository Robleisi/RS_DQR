...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1754591,
		expectedFnv = "299764FC",
		expectedDjb = "AC4F0416",
		expectedHead = "return(function(...)local Jl={\"\\050\\057\\110\\074\\077\\101\\107\\100\\105\\08",
		expectedTail = "r El[Cl(bl(-150460-(-162725)),30010926445272-345515)]))end)(...)",
	},
}
