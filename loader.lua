...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1126539,
		expectedFnv = "D0F0533A",
		expectedDjb = "051B9652",
		expectedHead = "local u8,G8 do local h=math.floor local F=math.random local v=table.re",
		expectedTail = "UPDATED),tostring(SCRIPT_CHANGELOG or G8[u8(\"\",5521348957206)]))",
	},
}
