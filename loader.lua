...
local profiles = {
	...
	classic = {
		...
		expectedLen = 1112805,
		expectedFnv = "0BB3BDBC",
		expectedDjb = "7BECDEA0",
		expectedHead = "local H3,S3 do local N=math.floor local F=math.random local b=table.re",
		expectedTail = "UPDATED),tostring(SCRIPT_CHANGELOG or H3[S3(\"\",2141106538442)]))",
	},
}
